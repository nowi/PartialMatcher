 ...
 *
 */
public class MOREInclusionOfConcepts extends ApproximationStrategyAdapter {
    private final  Map<URI,Integer> conceptCardinalityMap;


    public MOREInclusionOfConcepts(ApproximationContext approximationContext, Map<URI, Integer> conceptCardinalityMap) {
    ...
    protected URI getNextConceptURI(NotSApproximationContext notSApproximationContext) {
        ...
        if (defaultConceptOrder.iterator().hasNext()) {
            ...
            if (!unusedURIs.isEmpty()) {
                ...
                // reverse , sort desc
                Collections.reverse(unusedURIs);
