...
//
//        // the matchresult 1
//        Iterator<Set<OWLClass>> iter = partialMatches.values().iterator();
//
//        Set<OWLClass> partialMatch1 = iter.next();
//
//        assertFalse(partialMatch1.contains(advert2));
//        assertFalse(partialMatch1.contains(advert1));
//
//        // the  matchresult 2
//        Set<OWLClass> partialMatch2 = iter.next();
...
//
//        // the  matchresult 3
//        Set<OWLClass> partialMatch3 = iter.next();
//
...
//        Set<OWLClass> partialMatch = partialMatches.get(randomInclusion.getInitialContext());
